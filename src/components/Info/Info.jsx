...
const Info = (props) => {
    const {name,nativeName,flag,capital,population,region,subregion,topLevelDomain,currencies = [],languages = [], borders = []} = props
            ...
            <div>
                ...
                <Meta>
                    ...
                    {!borders.length ? (
                        ...
                        <TagGroup>
                            {neighbors.map(b => <Link style={{textDecoration: 'none', color: "inherit"}} to={`/country/${b}`}><Tag key={b}>{b}</Tag></Link>)}
                        </TagGroup>
                    )}
                </Meta>
            </div>
